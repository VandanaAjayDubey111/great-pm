...
- Internal task identifier: `ai_rollback_strategist`. Canonical role: `ai-rollback-strategist`; keep this canonical name in filenames, verdict logs, and user-facing output.
