...
- Internal task identifier: `product_strategist`. Canonical role: `product-strategist`; keep this canonical name in filenames, verdict logs, and user-facing output.
