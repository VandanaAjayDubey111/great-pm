...
- Internal task identifier: `enterprise_saas_pm_reviewer`. Canonical role: `enterprise-saas-pm-reviewer`; keep this canonical name in filenames, verdict logs, and user-facing output.
