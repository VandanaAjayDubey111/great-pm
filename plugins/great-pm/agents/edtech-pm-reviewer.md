...
- Internal task identifier: `edtech_pm_reviewer`. Canonical role: `edtech-pm-reviewer`; keep this canonical name in filenames, verdict logs, and user-facing output.
