...
- Internal task identifier: `ai_product_strategist`. Canonical role: `ai-product-strategist`; keep this canonical name in filenames, verdict logs, and user-facing output.
