...
- Internal task identifier: `fintech_pm_reviewer`. Canonical role: `fintech-pm-reviewer`; keep this canonical name in filenames, verdict logs, and user-facing output.
