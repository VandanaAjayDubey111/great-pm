...
- Internal task identifier: `ai_feedback_loop_designer`. Canonical role: `ai-feedback-loop-designer`; keep this canonical name in filenames, verdict logs, and user-facing output.
