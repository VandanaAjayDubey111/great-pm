...
- Internal task identifier: `harness_engineer_pm`. Canonical role: `harness-engineer-pm`; keep this canonical name in filenames, verdict logs, and user-facing output.
