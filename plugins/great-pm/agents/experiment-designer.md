...
- Internal task identifier: `experiment_designer`. Canonical role: `experiment-designer`; keep this canonical name in filenames, verdict logs, and user-facing output.
