...
- Internal task identifier: `ai_experimentation_pm`. Canonical role: `ai-experimentation-pm`; keep this canonical name in filenames, verdict logs, and user-facing output.
