...
- Internal task identifier: `ai_launch_strategist`. Canonical role: `ai-launch-strategist`; keep this canonical name in filenames, verdict logs, and user-facing output.
