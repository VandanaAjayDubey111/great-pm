...
- Internal task identifier: `feedback_synthesizer`. Canonical role: `feedback-synthesizer`; keep this canonical name in filenames, verdict logs, and user-facing output.
