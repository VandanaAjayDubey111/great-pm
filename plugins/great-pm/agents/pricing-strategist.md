...
- Internal task identifier: `pricing_strategist`. Canonical role: `pricing-strategist`; keep this canonical name in filenames, verdict logs, and user-facing output.
