...
- Internal task identifier: `marketplace_pm_reviewer`. Canonical role: `marketplace-pm-reviewer`; keep this canonical name in filenames, verdict logs, and user-facing output.
