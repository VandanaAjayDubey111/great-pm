...
- Internal task identifier: `ai_roadmap_planner`. Canonical role: `ai-roadmap-planner`; keep this canonical name in filenames, verdict logs, and user-facing output.
