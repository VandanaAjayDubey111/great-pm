...
- Internal task identifier: `prioritization_analyst`. Canonical role: `prioritization-analyst`; keep this canonical name in filenames, verdict logs, and user-facing output.
