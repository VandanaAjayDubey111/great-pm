...
- Internal task identifier: `creator_platform_pm_reviewer`. Canonical role: `creator-platform-pm-reviewer`; keep this canonical name in filenames, verdict logs, and user-facing output.
