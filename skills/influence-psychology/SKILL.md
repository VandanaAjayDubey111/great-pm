...
> **Provenance.** Vendored from `wondelai/skills@influence-psychology` (MIT License — github.com/wondelai/skills). Adapted into great-pm 2026-05-29 with attribution. Reference deep-dives (references/*.md) live upstream. Host agent: gtm-strategist.
