...
> **Provenance.** Vendored from `wondelai/skills@jobs-to-be-done` (MIT License — github.com/wondelai/skills). Adapted into great-pm 2026-05-29 with attribution. Reference deep-dives (references/*.md) live upstream. Host agent: user-researcher.
