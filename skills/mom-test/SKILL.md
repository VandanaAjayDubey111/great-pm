...
> **Provenance.** Vendored from `wondelai/skills@mom-test` (MIT License — github.com/wondelai/skills). Adapted into great-pm 2026-05-29 with attribution. Reference deep-dives (references/*.md) live upstream. Host agent: user-researcher.
...
See: [references/question-patterns.md](references/question-patterns.md)
...
See: [references/avoiding-bad-data.md](references/avoiding-bad-data.md)
...
See: [references/commitment-advancement.md](references/commitment-advancement.md)
...
See: [references/finding-conversations.md](references/finding-conversations.md)
...
See: [references/processing-learning.md](references/processing-learning.md)
